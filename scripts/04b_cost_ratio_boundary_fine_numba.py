...
OUT = "critical_boundary_cost_ratio_fine_results"
...
COST_RATIOS = np.array([10, 15, 20, 25, 30, 35, 40, 45, 50], dtype=np.float64)
...
def write_report(df, by_ratio, by_delta_ratio, boundary_text):
    report = []
    report.append("# Benchmark 4B — Fine Critical Boundary vs Cost Ratio")
    report.append("")
    report.append("## Purpose")
    report.append("")
    report.append("Fine sweep over cost ratios 10–50 to locate the economic critical boundary.")
    report.append("")
    report.append("## Setup")
    report.append("")
...
if __name__ == "__main__":
    ...
    print("Running Benchmark 4B — Fine Critical Boundary vs Cost Ratio...")
